...
files.forEach((filePath) => {
  ...
  if (content.toLowerCase().includes('inside') || content.toLowerCase().includes('candle')) {
    console.log(`Found in: ${path.relative('C:/Users/91934/.gemini/antigravity/scratch/brownies-and-frames', filePath)}`);
  }
});
