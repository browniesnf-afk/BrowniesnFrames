...
const mockProducts: Product[] = [
  { id: '1', title: 'Belgian Chocolate Brownie', slug: 'belgian-chocolate-brownie', description: 'Rich, fudgy & decadent chocolate brownie.', price: 399, stock: 50, category: 'brownies', badge: 'BESTSELLER', images: ['/images/brownie_belgian.jpg', '/images/home_brownies.jpg', 'https://images.unsplash.com/photo-1606313564200-e75d5e30476c?q=80&w=800&auto=format&fit=crop'] },
  { id: '2', title: 'Walnut Brownie', slug: 'walnut-brownie', description: 'Crunchy walnuts with rich chocolate brownie.', price: 449, stock: 42, category: 'brownies', badge: 'NEW', images: ['/images/brownie_walnut.jpg', '/images/home_brownies.jpg', 'https://images.unsplash.com/photo-1564355808539-22fda35bed7e?q=80&w=800&auto=format&fit=crop'] },
  { id: '3', title: 'Nutella Brownie', slug: 'nutella-brownie', description: 'Gooey Nutella swirl in every bite.', price: 499, stock: 35, category: 'brownies', badge: null, images: ['/images/brownie_nutella.jpg', '/images/home_brownies.jpg', 'https://images.unsplash.com/photo-1606890737304-57a1ca8a5b62?q=80&w=800&auto=format&fit=crop'] },
  { id: '4', title: 'Biscoff Brownie', slug: 'biscoff-brownie', description: 'Biscoff spread with crunchy biscoff crumbs.', price: 449, stock: 30, category: 'brownies', badge: null, images: ['/images/brownie_biscoff.jpg', '/images/home_brownies.jpg', 'https://images.unsplash.com/photo-1589119908995-c6837fa14848?q=80&w=800&auto=format&fit=crop'] },
  { id: '5', title: 'Classic Collage Frame', slug: 'classic-collage-frame', description: 'Elegant wooden collage frame.', price: 799, stock: 25, category: 'frames', badge: 'BESTSELLER', images: ['/images/frame_classic.jpg', '/images/home_frames.jpg', 'https://images.unsplash.com/photo-1513519245088-0e12902e5a38?q=80&w=800&auto=format&fit=crop'], sizes: DEFAULT_FRAME_SIZES },
  { id: '6', title: 'Minimal Wooden Frame', slug: 'minimal-wooden-frame', description: 'Simple, natural & perfect for any space.', price: 599, stock: 20, category: 'frames', badge: 'NEW', images: ['/images/frame_minimal.jpg', '/images/home_frames.jpg', 'https://images.unsplash.com/photo-1544816155-12df9643f363?q=80&w=800&auto=format&fit=crop'], sizes: DEFAULT_FRAME_SIZES },
  { id: '7', title: 'Black Border Frame', slug: 'black-border-frame', description: 'Modern black frame with a premium matte finish.', price: 549, stock: 8, category: 'frames', badge: null, images: ['/images/frame_black.jpg', '/images/home_frames.jpg', 'https://images.unsplash.com/photo-1582555172866-f73bb12a2ab3?q=80&w=800&auto=format&fit=crop'], sizes: DEFAULT_FRAME_SIZES },
  { id: '8', title: 'Memories Collage Frame', slug: 'memories-collage-frame', description: 'Multiple memories, one beautiful frame.', price: 899, stock: 0, category: 'frames', badge: null, images: ['/images/frame_memories.jpg', '/images/home_frames.jpg', 'https://images.unsplash.com/photo-1579783902614-a3fb3927b675?q=80&w=800&auto=format&fit=crop'], sizes: DEFAULT_FRAME_SIZES },
  { id: '9', title: 'Premium Gift Hamper', slug: 'premium-gift-hamper', description: 'Luxury hamper with brownies & mug.', price: 1299, stock: 15, category: 'gifts', badge: 'BESTSELLER', images: ['/images/gift_hamper.jpg', '/images/home_gifts.jpg', 'https://images.unsplash.com/photo-1549465220-1a8b9238cd48?q=80&w=800&auto=format&fit=crop'] },
  { id: '10', title: 'Luxury Gift Box', slug: 'luxury-gift-box', description: 'Elegant gift box filled with delights.', price: 1099, stock: 5, category: 'gifts', badge: 'NEW', images: ['/images/gift_luxury.jpg', '/images/home_gifts.jpg', 'https://images.unsplash.com/photo-1513885535751-8b9238bd345a?q=80&w=800&auto=format&fit=crop'] },
  { id: '11', title: 'Brownie Gift Box', slug: 'brownie-gift-box', description: 'Delicious brownies in a gift box.', price: 899, stock: 22, category: 'gifts', badge: null, images: ['https://images.unsplash.com/photo-1549465220-1a8b9238cd48?q=80&w=800&auto=format&fit=crop', '/images/home_gifts.jpg', '/images/brownie_belgian.jpg'] },
  { id: '12', title: 'Brownie Bouquet', slug: 'brownie-bouquet', description: 'A unique bouquet made of rich brownies.', price: 1199, stock: 0, category: 'gifts', badge: 'NEW', images: ['https://images.unsplash.com/photo-1513885535751-8b9238bd345a?q=80&w=800&auto=format&fit=crop', '/images/home_gifts.jpg', '/images/brownie_nutella.jpg'] },
];
