...
const Gifts = () => {
  const { products, loading } = useProducts('gifts');

  return (
    <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-4 sm:py-8">
      
      {/* Hero Banner */}
      <div className="flex w-full h-[180px] sm:h-[300px] md:h-[360px] rounded-2xl sm:rounded-3xl overflow-hidden bg-[#F8D8CF] mb-6 sm:mb-8 group shadow-xs">
        ...
        <div className="w-[55%] md:w-1/2 p-4 sm:p-10 md:p-14 flex flex-col justify-center text-[#2C1A14] z-20">
          ...
          <p className="text-[#6E5F55] max-w-xs mb-3 sm:mb-6 leading-tight sm:leading-relaxed text-[10px] sm:text-sm font-sans">
            Thoughtful gifts for every occasion, beautifully packed with love.
          </p>
        ...
        <div className="w-[45%] md:w-1/2 h-full relative overflow-hidden">
          <img 
            src="/images/home_gifts.jpg" 
            alt="Gifts Collection"
            className="w-full h-full object-cover object-center group-hover:scale-105 transition-transform duration-700 ease-out"
          />
          {/* Left Edge Seamless Fade */}
          <div className="absolute inset-y-0 left-0 w-6 sm:w-20 bg-gradient-to-r from-[#F8D8CF] to-transparent z-10"></div>
        </div>
      </div>
