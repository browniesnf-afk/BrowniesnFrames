...
const fallbackProducts: Record<string, any> = {
  ...
  'belgian-chocolate-brownie': {
    ...
    images: ['/images/brownie_belgian.jpg', '/images/home_brownies.jpg'],
    rating: 5.0,
    reviews_count: 100,
    badge: 'BESTSELLER'
  },
  'walnut-brownie': {
    ...
    images: ['/images/brownie_walnut.jpg', '/images/home_brownies.jpg'],
    rating: 5.0,
    reviews_count: 96,
    badge: 'NEW'
  },
  ...
  'nutella-brownie': {
    ...
    images: ['/images/brownie_nutella.jpg', '/images/home_brownies.jpg'],
    rating: 5.0,
    reviews_count: 118,
    badge: 'BESTSELLER'
  },
  ...
  'biscoff-brownie': {
    ...
    images: ['/images/brownie_biscoff.jpg', '/images/home_brownies.jpg'],
    rating: 5.0,
    reviews_count: 87,
    badge: 'NEW'
  },
  ...
  'classic-collage-frame': {
    ...
    images: ['/images/frame_classic.jpg', '/images/home_frames.jpg'],
  ...
  'minimal-wooden-frame': {
    ...
    images: ['/images/frame_minimal.jpg', '/images/home_frames.jpg'],
    sizes: DEFAULT_FRAME_SIZES,
    rating: 5.0,
    reviews_count: 96,
    badge: 'NEW'
  ...
  'black-border-frame': {
    ...
    images: ['/images/frame_black.jpg', '/images/home_frames.jpg'],
    sizes: DEFAULT_FRAME_SIZES,
    rating: 5.0,
    reviews_count: 72,
    badge: 'POPULAR'
  ...
  'memories-collage-frame': {
    ...
    images: ['/images/home_frames.jpg', '/images/frame_memories.jpg'],
    sizes: DEFAULT_FRAME_SIZES,
    rating: 5.0,
    reviews_count: 54,
    badge: 'BESTSELLER'
  ...
  'premium-gift-hamper': {
    ...
    images: ['/images/gift_hamper.jpg', '/images/home_gifts.jpg'],
    rating: 5.0,
    reviews_count: 145,
    badge: 'BESTSELLER'
  },
  'luxury-gift-box': {
    ...
    images: ['/images/gift_luxury.jpg', '/images/home_gifts.jpg'],
    rating: 5.0,
    reviews_count: 98,
    badge: 'NEW'
  },
  'brownie-gift-box': {
    ...
    images: ['https://images.unsplash.com/photo-1549465220-1a8b9238cd48?q=80&w=800&auto=format&fit=crop', '/images/home_gifts.jpg'],
    rating: 5.0,
    reviews_count: 112,
    badge: 'POPULAR'
  },
  'brownie-bouquet': {
    ...
    images: ['https://images.unsplash.com/photo-1513885535751-8b9238bd345a?q=80&w=800&auto=format&fit=crop', '/images/home_gifts.jpg'],
    rating: 5.0,
    reviews_count: 76,
    badge: 'NEW'
  }
  ...
  return (
    <div className="max-w-md mx-auto px-4 py-4 sm:py-6">
      ...
      <div className="flex flex-col space-y-1.5">
        ...
        {/* What's Inside Gallery (for Gift Hampers) */}
        {(product.category?.toLowerCase() === 'gifts' || product.whats_inside) && (
          <div className="pt-2">
